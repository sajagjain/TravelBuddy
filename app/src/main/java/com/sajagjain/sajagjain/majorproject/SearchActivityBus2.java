...
public class SearchActivityBus2 extends AppCompatActivity {
...
//
        ...
        searchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            ...
            public void onSearchViewClosed() {
                listview = (ListView) findViewById(R.id.listviewbus);
                ArrayAdapter adapter = new ArrayAdapter(SearchActivityBus2.this, android.R.layout.simple_list_item_1, list);
                listview.setAdapter(adapter);
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (newText != null || !newText.isEmpty()) {
                    ...
                    ArrayAdapter adapter = new ArrayAdapter<>(SearchActivityBus2.this
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for (BusStandFirstStep i : responses) {
                    if (item.equals(i.getBusStandCityName() + "(" + i.getBusStandCityState() + ")")){
                        ...
                        busDestination=i.getBusStandCityName();
                    }
                }
                Log.d("item", item);
                Intent intent = new Intent();
                intent.putExtra("datasourcevalue6", item).putExtra("busDestination",busDestination);
                Toast.makeText(SearchActivityBus2.this, item, Toast.LENGTH_LONG).show();
                setResult(RESULT_OK, intent);
                finish();
            }
        });
