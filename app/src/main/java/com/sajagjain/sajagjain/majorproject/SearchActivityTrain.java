...
public class SearchActivityTrain extends AppCompatActivity {
...
//
        ...
        searchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            ...
            public void onSearchViewClosed() {
                listview = (ListView) findViewById(R.id.listviewtrain);
                ArrayAdapter adapter = new ArrayAdapter(SearchActivityTrain.this, android.R.layout.simple_list_item_1, list);
                listview.setAdapter(adapter);
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (newText != null || !newText.isEmpty()) {
                    ...
                    ArrayAdapter adapter = new ArrayAdapter<>(SearchActivityTrain.this
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for (TrainStationFirstStep i : responses) {
                    if (item.equals(i.getStation() + "(" + i.getStationCode() + ") - " + i.getStationState())) {
                        ...
                        sourceName=i.getStation();
                    }
                }
                Log.d("item", item);
                Intent intent = new Intent();
                intent.putExtra("datasourcevalue3", item).putExtra("trainSource",sourceName);
                Toast.makeText(SearchActivityTrain.this, item, Toast.LENGTH_LONG).show();
                setResult(RESULT_OK, intent);
                finish();
            }
        });
